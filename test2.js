...
async function mintNFT() {
  ...
  try {
    ...
    const contractAddress = Address.parse("EQAQeuVSEP6zjSLKA988fruEXm9ds6knS6ZpaxJT8gIIis3m");
      ...
      messages: [
        {
          ...
          amount: "600000000", // 0.6 TON для покрытия 0.55 TON + комиссий
...
console.log("DescriptionCell BOC:", descriptionCell.toBoc().toString("base64"));
console.log("Payload BOC:", payload.toBoc().toString("base64"));
