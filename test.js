...
async function mintNFT() {
  ...
  if (!window.Ton) {
    console.error("Ton library not loaded");
  ...
  try {
    ...
    const metadataCell = window.Ton.beginCell().storeStringTail(metadataJson).endCell();

    const Address = window.Ton.Address;
    const beginCell = window.Ton.beginCell;
